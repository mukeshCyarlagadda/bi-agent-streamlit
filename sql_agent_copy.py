...
def convert_dataframe(state: GraphState, conn):
    ...
    # Convert DataFrame to dict in a way that preserves structure
...
if __name__ == "__main__":
    # 1. Provide a db_uri
    db_uri = "sqlite:///database/sakila.db"  # or your actual path
    ...
    # 3. Test a question
    QUESTION = """
    show the desnisty curve of the payments 
    """
